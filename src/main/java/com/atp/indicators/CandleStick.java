...
public class CandleStick extends AbstractIndicator {
	...
	public CandleStick(int type) {
		this("Candle",type);
	}

	public CandleStick(int type, boolean justLastDay) {
		this("Candle",type, justLastDay);
	}

	public CandleStick(String name, int type) {
		super(name, true);
		this.type = type;
		priceBars = new ArrayList<PriceBar>();
	}

	public CandleStick(String name, int type, boolean justLastDay) {
